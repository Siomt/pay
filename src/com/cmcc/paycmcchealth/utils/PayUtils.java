package com.cmcc.paycmcchealth.utils;
...
import com.cmcc.paycmcchealth.ui.H5PayDemoActivity;

/**
 * 支付宝支付工具类 
 * Created by liuhuan 2016/05/17
 */
public class PayUtils {
	...
	public PayUtils(Activity activity, PayInfoBean payInfoBean, Handler handler) {
	...
	private String getOrderInfo() {
		...
		// 商品金额
		orderInfo += "&total_fee=" + "\"" + payInfo.getPrice() + "\"";
